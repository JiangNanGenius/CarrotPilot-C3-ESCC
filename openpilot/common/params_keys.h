...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"LongitudinalPersonality", {PERSISTENT | BACKUP, INT, "1"}},
    ...
    {"CurveSpeedControlMode", {PERSISTENT | BACKUP, INT, "1"}},
    ...
    {"CarrotLearningApply", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"CarrotLearningAutoApply", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"CarrotLearningClear", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"CarrotLearningData", {PERSISTENT, BYTES, ""}},
    {"CarrotLearningHistory", {PERSISTENT | BACKUP, BYTES, ""}},
    {"CarrotLearningIgnore", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"CarrotLearningPopupReady", {PERSISTENT, BOOL, "0"}},
    ...
    {"CarrotNaviDebug", {CLEAR_ON_MANAGER_START, JSON}},
    {"CarrotNaviEvent", {CLEAR_ON_MANAGER_START, JSON}},
    {"CarrotNaviImage", {CLEAR_ON_MANAGER_START, JSON}},
    {"CarrotNavigationEvent", {CLEAR_ON_MANAGER_START, JSON}},
    {"CarrotRainWet", {PERSISTENT | BACKUP, BOOL, "0"}},
    ...
    {"CarrotTunerFactoryReset", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"CarrotDSPRecommend", {PERSISTENT, BYTES, ""}},

    // Auto-Tuner target values are stored for the future Carrot control migration.
    ...
    {"CruiseMaxVals1", {PERSISTENT | BACKUP, INT, "200"}},
    {"CruiseMaxVals2", {PERSISTENT | BACKUP, INT, "160"}},
    {"CruiseMaxVals3", {PERSISTENT | BACKUP, INT, "130"}},
    {"CruiseMaxVals4", {PERSISTENT | BACKUP, INT, "110"}},
    {"CruiseMaxVals5", {PERSISTENT | BACKUP, INT, "95"}},
    {"CruiseMaxVals6", {PERSISTENT | BACKUP, INT, "80"}},
    {"DynamicTFollowLC", {PERSISTENT | BACKUP, INT, "100"}},
    {"DynamicTFollow", {PERSISTENT | BACKUP, INT, "0"}},
    {"EnableSpeedTF", {PERSISTENT | BACKUP, INT, "0"}},
    {"JLeadFactor3", {PERSISTENT | BACKUP, INT, "0"}},
    ...
    {"MyDrivingMode", {PERSISTENT | BACKUP, INT, "3"}},
    {"MyDrivingModeAuto", {PERSISTENT | BACKUP, INT, "0"}},
    {"PathOffset", {PERSISTENT | BACKUP, INT, "0"}},
    {"RadarReactionFactor", {PERSISTENT | BACKUP, INT, "100"}},
    {"SteerActuatorDelay", {PERSISTENT | BACKUP, INT, "0"}},
    {"SteerRatioRate", {PERSISTENT | BACKUP, INT, "100"}},
    {"StopDistanceCarrot", {PERSISTENT | BACKUP, INT, "550"}},
    {"TFollowDecelBoost", {PERSISTENT | BACKUP, INT, "10"}},
    ...
    {"TFollowSpeedFactor", {PERSISTENT | BACKUP, INT, "0"}},
    {"TrafficLightDetectMode", {PERSISTENT | BACKUP, INT, "2"}},
