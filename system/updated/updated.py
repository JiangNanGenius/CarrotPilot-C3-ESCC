...
from openpilot.system.version import get_build_metadata, get_version, SP_BRANCH_MIGRATIONS
...
class Updater:
  ...
  def set_params(self, update_success: bool, failed_count: int, exception: str | None) -> None:
    ...
    # Personal C3 build: keep manual GitHub updates, but never block startup or
    # show comma-style connectivity nag alerts when the device is intentionally
    # unpaired from cloud services.
