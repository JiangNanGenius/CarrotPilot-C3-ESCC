...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"CASResidualGain", {PERSISTENT, INT, "150"}},
    {"CASModelName", {CLEAR_ON_OFFROAD_TRANSITION, STRING}},
    {"CASModelHours", {CLEAR_ON_OFFROAD_TRANSITION, STRING}},
    {"CarrotDataUpload", {PERSISTENT, INT, "0"}},
    {"CarrotUploadWifiOnly", {PERSISTENT, INT, "1"}},
    {"CarrotUploadMinBattery", {PERSISTENT, INT, "0"}},
    {"CarrotUploadOnlyOffroad", {PERSISTENT, INT, "0"}},
    {"CarrotUploadEndpoint", {PERSISTENT, STRING}},
    {"CarrotDeviceId", {PERSISTENT, STRING}},
