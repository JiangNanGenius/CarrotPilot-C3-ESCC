...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"CarrotSpeedLimitEnable", {PERSISTENT | BACKUP, BOOL, "1"}},
    {"CarrotTrafficStopEnable", {PERSISTENT | BACKUP, BOOL, "0"}},
    ...
    {"LastKnownSystemTime", {PERSISTENT, TIME}},
    ...
    {"HyundaiEpsAngleFaultProtection", {PERSISTENT | BACKUP, BOOL, "1"}},
    {"HyundaiEpsAngleFaultTriggerSeconds", {PERSISTENT | BACKUP, FLOAT, "0.9"}},
    {"HyundaiSteerTorqueScale", {PERSISTENT | BACKUP, INT, "105"}},
    ...
    {"OnroadScreenOffBrightnessMigrated", {PERSISTENT | BACKUP, STRING, "1.0"}},
    {"OnroadScreenOffTimer", {PERSISTENT | BACKUP, INT, "15"}},
    {"OnroadScreenOffTimerMigrated", {PERSISTENT | BACKUP, STRING, "1.0"}},
