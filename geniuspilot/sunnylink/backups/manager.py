...
from geniuspilot.sunnylink.api import SunnylinkApi
from geniuspilot.sunnylink.backups.utils import decrypt_compressed_data, encrypt_compress_data, SnakeCaseEncoder
from geniuspilot.sunnylink.utils import get_param_as_byte, save_param_from_base64_encoded_string
...
class BackupManagerSP:
  ...
  def _get_current_version(self) -> custom.BackupManagerSP.Version:
    """Gets current geniuspilot version information."""
