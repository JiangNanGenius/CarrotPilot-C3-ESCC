...
import gzip
import json
from geniuspilot.sunnylink.api import SunnylinkApi, UNREGISTERED_SUNNYLINK_DONGLE_ID
...
def _convert_param_to_type(value: bytes, param_type: ParamKeyType) -> bytes | str | int | float | bool | dict | None:
  ...
  If this method looks familiar, it's because on SP we have a similar one in openpilot/geniuspilot/car/__init__.py.
  """
