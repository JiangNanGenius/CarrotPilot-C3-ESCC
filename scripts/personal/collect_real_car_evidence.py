...
def build_checklist(output_dir: Path, sample_seconds: int, archive_path: Optional[Path]) -> str:
  ...
  lines.append("")
  lines.append("After filling the road-test log, copy the folder to the computer and run:")
  lines.append("")
  lines.append("```bash")
  lines.append("python3 scripts/personal/road_test_evidence_check.py \\")
  lines.append("  --road-test-log /path/to/road-test-log-draft.md \\")
  lines.append("  --device-snapshot /path/to/device-snapshot.md \\")
