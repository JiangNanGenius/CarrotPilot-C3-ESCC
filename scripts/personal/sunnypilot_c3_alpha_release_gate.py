...
def build_steps(args: argparse.Namespace) -> list[tuple[str, list[str], int]]:
  ...
  steps: list[tuple[str, list[str], int]] = [
    ...
    ("Genius Carrot settings guide", [py(), "scripts/personal/genius_carrot_settings_guide_contract.py", "--self-test"], 30),
    ("Genius Carrot Web API contract", [py(), "scripts/personal/genius_carrot_web_api_contract.py", "--self-test"], 30),
    ("Genius Navipilot/APN replay contract", [py(), "scripts/personal/genius_navipilot_replay_contract.py", "--self-test"], 30),
    ("Genius cluster/world schema contract", [py(), "scripts/personal/genius_cluster_world_contract.py", "--self-test"], 30),
    ("Fishop hardware sample replay", [py(), "scripts/personal/fishop_hardware_sample.py", "--self-test"], 30),
