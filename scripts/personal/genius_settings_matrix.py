...
MATRIX: tuple[MatrixRow, ...] = (
  ...
  MatrixRow("SpeedLimitPolicy", "carrot", "speed_limit", "SpeedLimitPolicy", "5", ("SpeedLimitPolicy",), ui_surface="speed_limit", api=True, notes="Phone-first resolver policy: fresh phone/APN/N/Navipilot/Carrot data, then vehicle/cluster. OSM/mapd is opt-in through map policies."),
  ...
  MatrixRow("CarrotActiveSpeedControlEnabled", "carrot", "active_control_gate", "CarrotActiveSpeedControlEnabled", "0", ("AutoCruiseControl", "AutoSpeedUptoRoadSpeedLimit"), ui_surface="cruise+carrot", api=True, notes="User-toggleable while offroad; Carrot cruise-target gate. Speed-limit changes still require SpeedLimitMode=Assist."),
  MatrixRow("CarrotAutoTurnControlEnabled", "carrot", "active_control_gate", "CarrotAutoTurnControlEnabled", "0", ("AutoTurnControl", "AutoTurnControlSpeedTurn", "AutoTurnControlTurnEnd"), ui_surface="cruise+carrot", api=True, notes="Separate ATC/turn slowdown gate; CarrotCruiseAtcDecel belongs to this path only."),
  ...
  MatrixRow("CarrotCruiseAtcDecel", "carrot", "longitudinal", "CarrotCruiseAtcDecel", "-1", ("CarrotCruiseAtcDecel",), ui_surface="cruise+carrot", api=True, units="percent/auto", notes="-1 means Auto. ATC-only decel target; higher allows stronger requested turn slowdown, lower softens it."),
