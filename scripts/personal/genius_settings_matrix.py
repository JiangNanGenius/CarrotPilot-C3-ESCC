...
MATRIX: tuple[MatrixRow, ...] = (
  ...
  MatrixRow("CurveSpeedControlMode", "carrot", "curve_speed", "CurveSpeedControlMode", "1", ("AutoCurveSpeedFactor", "MapTurnSpeedFactor", "ModelTurnSpeedFactor", "VisionCurveSpeedController"), ui_surface="carrot", api=True, notes="Off/Sunny/Carrot/Fusion selector."),
