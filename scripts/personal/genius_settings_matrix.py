...
MATRIX: tuple[MatrixRow, ...] = (
  ...
  MatrixRow("CurveSpeedControlMode", "carrot", "curve_speed", "CurveSpeedControlMode", "1", ("AutoCurveSpeedFactor", "MapTurnSpeedFactor", "ModelTurnSpeedFactor", "VisionCurveSpeedController"), ui_surface="cruise+carrot", api=True, notes="Off/Sunny/Carrot/Fusion selector; owns Sunny SCC-V participation while SCC-M stays inert."),
  ...
  MatrixRow("AutoNaviSpeedDecelRate", "carrot", "navigation_speed", "AutoNaviSpeedDecelRate", "120", ("AutoNaviSpeedDecelRate",), ui_surface="cruise+carrot", api=True, units="percent"),
  ...
  MatrixRow("TurnSpeedControlMode", "carrot", "turn_speed", "TurnSpeedControlMode", "1", ("TurnSpeedControlMode",), ui_surface="cruise+carrot", api=True, notes="Off/Carrot/Sunny/Fusion selector."),
