...
MATRIX: tuple[MatrixRow, ...] = (
  ...
  MatrixRow("CarrotPhoneSpeedLimitEnabled", "carrot", "speed_limit", "CarrotPhoneSpeedLimitEnabled", "1", ("CarrotPhoneSpeedLimitEnabled", "CarrotNaviDebug", "CarrotNaviImage"), ui_surface="carrot", api=True, notes="Fresh APN/N/Navipilot/Carrot phone speed source."),
  ...
  MatrixRow("CurveSpeedControlMode", "carrot", "curve_speed", "CurveSpeedControlMode", "1", ("AutoCurveSpeedFactor", "MapTurnSpeedFactor", "ModelTurnSpeedFactor", "VisionCurveSpeedController"), ui_surface="carrot", api=True, notes="Off/Sunny/Carrot/Fusion selector; owns Sunny SCC-V participation while SCC-M stays inert."),
  ...
  MatrixRow("AutoCurveSpeedFactor", "carrot", "curve_speed", "AutoCurveSpeedFactor", "120", ("AutoCurveSpeedFactor",), ui_surface="carrot", api=True, units="percent", notes="Higher usually keeps more speed through curves."),
  MatrixRow("AutoCurveSpeedAggressiveness", "carrot", "curve_speed", "AutoCurveSpeedAggressiveness", "100", ("AutoCurveSpeedAggressiveness",), ui_surface="carrot", api=True, units="percent"),
  MatrixRow("AutoNaviSpeedDecelRate", "carrot", "navigation_speed", "AutoNaviSpeedDecelRate", "120", ("AutoNaviSpeedDecelRate",), ui_surface="carrot", api=True, units="percent"),
  MatrixRow("CarrotActiveSpeedControlEnabled", "carrot", "active_control_gate", "CarrotActiveSpeedControlEnabled", "0", ("AutoCruiseControl", "AutoSpeedUptoRoadSpeedLimit"), ui_surface="carrot", api=True, notes="User-toggleable while offroad; controls active speed path gate."),
  MatrixRow("CarrotAutoTurnControlEnabled", "carrot", "active_control_gate", "CarrotAutoTurnControlEnabled", "0", ("AutoTurnControl", "AutoTurnControlSpeedTurn", "AutoTurnControlTurnEnd"), ui_surface="carrot", api=True),
  MatrixRow("CarrotTrafficStopEnabled", "carrot", "active_control_gate", "CarrotTrafficStopEnabled", "0", ("TrafficLight", "TrafficLightDetectMode"), ui_surface="carrot", api=True),
  MatrixRow("TurnSpeedControlMode", "carrot", "turn_speed", "TurnSpeedControlMode", "1", ("TurnSpeedControlMode",), ui_surface="carrot", api=True, notes="Off/Carrot/Sunny/Fusion selector."),
  ...
  MatrixRow("TrafficLightDetectMode", "carrot", "traffic_light", "TrafficLightDetectMode", "2", ("TrafficLightDetectMode",), ui_surface="carrot", api=True),
  MatrixRow("TrafficStopDistanceAdjust", "carrot", "traffic_light", "TrafficStopDistanceAdjust", "-150", ("TrafficStopDistanceAdjust",), ui_surface="carrot", api=True, units="cm"),
  ...
  MatrixRow("CarrotCruiseDecel", "carrot", "longitudinal", "CarrotCruiseDecel", "-1", ("CarrotCruiseDecel",), ui_surface="carrot", api=True, units="percent/auto", notes="-1 means Auto."),
  MatrixRow("CarrotCruiseAtcDecel", "carrot", "longitudinal", "CarrotCruiseAtcDecel", "-1", ("CarrotCruiseAtcDecel",), ui_surface="carrot", api=True, units="percent/auto", notes="-1 means Auto."),
  ...
  MatrixRow("CruiseMaxVals0", "carrot", "accel_table", "CruiseMaxVals0", "160", ("CruiseMaxVals0",), ui_surface="carrot", api=True),
  MatrixRow("CruiseMaxVals1", "carrot", "accel_table", "CruiseMaxVals1", "200", ("CruiseMaxVals1",), ui_surface="carrot", api=True),
  MatrixRow("CruiseMaxVals2", "carrot", "accel_table", "CruiseMaxVals2", "160", ("CruiseMaxVals2",), ui_surface="carrot", api=True),
  MatrixRow("CruiseMaxVals3", "carrot", "accel_table", "CruiseMaxVals3", "130", ("CruiseMaxVals3",), ui_surface="carrot", api=True),
  MatrixRow("CruiseMaxVals4", "carrot", "accel_table", "CruiseMaxVals4", "110", ("CruiseMaxVals4",), ui_surface="carrot", api=True),
  MatrixRow("CruiseMaxVals5", "carrot", "accel_table", "CruiseMaxVals5", "95", ("CruiseMaxVals5",), ui_surface="carrot", api=True),
  MatrixRow("CruiseMaxVals6", "carrot", "accel_table", "CruiseMaxVals6", "80", ("CruiseMaxVals6",), ui_surface="carrot", api=True),
  MatrixRow("LongTuningKpV", "carrot", "longitudinal_tune", "LongTuningKpV", "100", ("LongTuningKpV",), ui_surface="carrot", api=True, units="percent"),
  ...
  MatrixRow("LongActuatorDelay", "carrot", "longitudinal_tune", "LongActuatorDelay", "20", ("LongActuatorDelay",), ui_surface="carrot", api=True, units="centiseconds"),
  MatrixRow("VEgoStopping", "carrot", "longitudinal_tune", "VEgoStopping", "50", ("VEgoStopping",), ui_surface="carrot", api=True, units="km/h scale"),
  ...
  MatrixRow("PathOffset", "carrot", "steering_path", "PathOffset", "0", ("PathOffset", "IQLanePlannerPathOffset"), ui_surface="carrot", api=True, units="cm", notes="0 is neutral."),
  MatrixRow("SteerActuatorDelay", "carrot", "steering_path", "SteerActuatorDelay", "0", ("SteerActuatorDelay",), ui_surface="carrot", api=True, units="centiseconds"),
