...
def check_navipilot_app_source_contract(report: Report) -> None:
  ...
  files = {
    ...
    "app/src/main/java/com/example/navipilot/MainActivityLifecycle.kt": [
      ...
      "vEgoKph",
      "gps_speed",
      "isHardAcceleration = acceleration > 3.0f",
      "isHardBraking = acceleration < -4.0f",
    ...
    "app/src/main/java/com/example/navipilot/scoring/DrivingDataCollector.kt": [
      ...
      "fun getAllSessionsIncludingCurrent()",
      "fun getTodaySessions()",
      "fun getWeekSessions()",
      "fun hasData()",
    ],
    "app/src/main/java/com/example/navipilot/scoring/DrivingScoreEngine.kt": [
      "fun calculateTotalScore",
      "s * 0.30 + p * 0.25 + i * 0.20 + e * 0.15 + st * 0.10",
    ...
    "app/src/main/java/com/example/navipilot/scoring/DrivingSession.kt": [
      "data class DrivingSession",
      "val totalDistance: Float",
      "val nooDistance: Float",
      "val avgSpeed: Float",
      "val smoothnessScore: Int",
      "val predictionScore: Int",
      "val interventionScore: Int",
      "val ecoScore: Int",
      "val stabilityScore: Int",
      "val totalScore: Int",
      "val interventionDetails: List<InterventionDetail>",
      "data class InterventionDetail",
      "data class Achievement",
    ],
    "app/src/main/java/com/example/navipilot/ui/driving/DrivingReportScreen.kt": [
      "fun DrivingReportScreen(",
      "drivingDataCollector: DrivingDataCollector?",
      "getAllSessionsIncludingCurrent()",
      "getTodaySessions()",
      "getWeekSessions()",
      "isCollecting()",
    ...
    "app/src/main/java/com/example/navipilot/ui/driving/DrivingReportShareImage.kt": [
