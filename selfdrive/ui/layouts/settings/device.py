...
DESCRIPTIONS = {
  ...
  'reset_calibration': tr_noop("Genius Pilot requires the device to be mounted within 4° left or right and within 5° up or 9° down."),
  'review_guide': tr_noop("Review the rules, features, and limitations of Genius Pilot"),
}
...
class DeviceLayout(Widget):
  ...
  def _update_calib_description(self):
    ...
    desc += "<br><br>"
    desc += tr("Genius Pilot is continuously calibrating, resetting is rarely required. " +
               "Resetting calibration will restart Genius Pilot if the car is powered on.")
