...
// CAS HUD overlay is implemented in selfdrive/ui/cas_debug.{h,cc}.
// Kept separate so the entire CAS UI can be removed by deleting that file pair
// and dropping this include + the call site below. See cas_debug.h.
...
// ui_draw_cas_overlay() is defined in selfdrive/ui/cas_debug.cc.
