...
class UpdateOpenpilotBigButton(BigButton):
  def __init__(self):
    ...
    super().__init__("update Genius Pilot", "", self._txt_update_icon)
  ...
  def set_value(self, value: str):
    ...
    if value:
      ...
      self.set_text("update Genius Pilot")
...
class DeviceLayoutMici(NavScroller):
  def __init__(self):
    ...
    uninstall_openpilot_btn = EngagedConfirmationButton("uninstall Genius Pilot", "uninstall",
